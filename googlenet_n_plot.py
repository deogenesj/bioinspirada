...
print('matriz de confusão', confusion_mtx)

class_names=['airplane', 'automobile', 'bird', 'cat', 'deer', 'dog', 'frog', 'horse', 'ship', 'truck']
plot_confusion_matrix(y_test_arg, y_pred, classes = class_names, title = 'Matriz de Confusão, sem normalização')
plot_confusion_matrix(y_test_arg, y_pred, classes = class_names, normalize=True, title='Matrix de Confusão Normalizada')
